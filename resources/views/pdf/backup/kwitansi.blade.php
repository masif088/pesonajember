...
<head>
    ...
    <style>
        ...
        #header {  left: 0px; right: 0px; height: 100%;position: absolute; background-color: orange; text-align: center; }
...
<div class="wrapper-page page">
    <div id="header">
        <img src="{{ public_path('front/background-pdf-kwitansi.png') }}" alt="" style="height: 100%">
    </div>
    <div style="position: absolute; z-index: 2; width: 100%; margin: 170px 8%;" id="content">
        <div style="width: 84% ">
            <div>
                <div
                ...
                <div>
                    ...
                    <div style="margin: 100px 8%;"></div>
                            @endif
                            <table class="invoice-table table-page">
                                <thead>
