...
['title' => 'Nominal Margin Profit',
 'value' => 'Rp. ' . thousand_format(($afterTax - $allSharing - $totalHpp)) .
           ' (' . (($afterTax != 0) ? number_format((($afterTax - $allSharing - $totalHpp) / $afterTax) * 100, 2, ',', '.') : 0) . "%)"],
