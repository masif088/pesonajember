...
<div class="col-span-12">
    <div class="owl-carousel counter-carousel owl-theme ">
        <div class="item">
            <div
                class="card mb-0 shadow-none bg-lightprimary dark:bg-darkprimary w-full">
                <div class="card-body">
                    <div class="text-center">
                        <div class="flex justify-center">
                            <img
                                src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/svgs/icon-user-male.svg"
        ...
        <div class="item">
            <div
                class="card mb-0 shadow-none bg-lightwarning dark:bg-darkwarning w-full">
                <div class="card-body">
                    <div class="text-center">
                        <div class="flex justify-center">
                            <img
                                src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/svgs/icon-briefcase.svg"
                                width="50" height="50" class="mb-3" alt>
                        </div>
        ...
        <div class="item">
            <div
                class="card mb-0 shadow-none bg-lightinfo dark:bg-darkinfo w-full">
                <div class="card-body">
                    <div class="text-center">
                        <div class="flex justify-center">
                            <img
                                src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/svgs/icon-mailbox.svg"
                                width="50" height="50" class="mb-3" alt>
                        </div>
        ...
        <div class="item">
            <div
                class="card mb-0 shadow-none bg-lighterror dark:bg-darkerror w-full">
                <div class="card-body">
                    <div class="text-center">
                        <div class="flex justify-center">
                            <img
                                src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/svgs/icon-favorites.svg"
                                width="50" height="50" class="mb-3" alt>
                        </div>
        ...
        <div class="item">
            <div
                class="card mb-0 shadow-none bg-lightsuccess dark:bg-darksuccess w-full">
                <div class="card-body">
                    <div class="text-center">
                        <div class="flex justify-center">
                            <img
                                src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/svgs/icon-speech-bubble.svg"
                                width="50" height="50" class="mb-3" alt>
                        </div>
            ...
            <div
                ...
                <div class="card-body">
                    <div class="text-center">
                        <div class="flex justify-center">
                            <img
                                src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/svgs/icon-connect.svg"
                                width="50" height="50" class="mb-3" alt>
                        </div>
                        <p class="font-semibold  text-primary mb-1">
                            Reports
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12">
                    <div class="flex items-center gap-4 pt-6">
                        ...
                        <div>
                            <h4
                                class="text-2xl text-dark dark:text-white font-semibold">
                                $63,489.50</h4>
                            <p>Total Earnings
                            </p>
                        </div>
                        ...
                        <div class="lg:col-span-8 md:col-span-8 col-span-8">
                            ...
                            <div class="flex gap-4 items-center">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="text-xs  dark:text-darklink">2023</span>
                                </div>
                                <div class="flex items-center">
                                    <i
                                        class="ti ti-point-filled text-secondary text-xl me-1"></i>
                                    <span
                                        class="text-xs  dark:text-darklink">2024</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3 items-center">
                    <div
                        ...
                        <i
                            class="ti ti-grid-dots opacity-70 dark:opacity-100 text-xl"></i>
                    </div>
                    <div>
            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="flex gap-4 items-center mb-8 pb-2">
                        <div>
                            <img
                                src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/profile/user-2.jpg"
                                class="rounded-md" alt width="72" height="72"/>
                        </div>
                        <div>
                            <h5
                                class="card-title mb-2 leading-tight">
                    ...
                    <div class="flex justify-between">
                        <div class="flex">
                            ...
                            <a href="javascript:void(0)" class="relative -ms-2">
                                <img
                                    src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/profile/user-3.jpg"
                                    class="rounded-full h-11 w-11 border-2 border-body dark:border-dark"
                                    alt="user"/>
                            </a>
                            <a href="javascript:void(0)" class="relative -ms-2">
                                <img
                                    src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/profile/user-4.jpg"
                                    class="rounded-full h-11 w-11 border-2 border-body dark:border-dark"
                                    alt="user"/>
                            </a>
                            <a href="javascript:void(0)" class="relative -ms-2">
                                <img
                                    src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/profile/user-5.jpg"
                                    class="rounded-full h-11 w-11 border-2 border-body dark:border-dark"
                                    alt="user"/>
                            </a>
                        </div>
    ...
    <div class="card bg-primary overflow-hidden">
        <div class="card-body pb-0 bg-primary">
            ...
            <div class="flex justify-center  mt-3">
                <img
                    src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/backgrounds/piggy.png"
                    class="w-full"
                    alt/>
            </div>
        </div>
            ...
            <div class="card ">
                <div class="card-body ">
                    <div class="mb-6">
                        ...
                        <!-- Progress -->
                        <div
                            class="flex w-full h-1 bg-lightprimary dark:bg-darkprimary rounded-md overflow-hidden"
                    ...
                    <div>
                        ...
                        <!-- Progress -->
                        <div
                            class="flex w-full h-1 bg-lightsecondary dark:bg-darksecondary rounded-md overflow-hidden"
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="flex items-center justify-between mb-7 pt-2">
                ...
                <span
                    class="badge-md bg-lightprimary dark:bg-darkprimary  text-primary">+68</span>
            ...
            <div class="flex items-center justify-between mb-7">
                ...
                <span
                    class="badge-md bg-lightsuccess dark:bg-darksuccess  text-success">+68</span>
            ...
            <div class="flex items-center justify-between">
                ...
                <span
                    class="badge-md bg-lighterror dark:bg-darkerror  text-error">+68</span>
                                ...
                                <tr>
                                    <td class="p-4 ps-0 whitespace-nowrap">
                                        <div class="flex gap-3 items-center">
                                            <div>
                                                <img
                                                    src="https://bootstrapdemos.adminmart.com/modernize-tailwind-pro/dist/assets/images/profile/user-7.jpg"
                                            ...
                                            <div>
                                                <h6
                                                    ...
                                                    Sunil Joshi</h6>
                                                <p
                                                    class="text-xs  dark:text-darklink">
                                                    Web Designer
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <td
                                        class=" whitespace-nowrap  dark:text-darklink p-4">
                                        Elite Admin
                                    </td>
                                    <td class="p-4">
																			<span
