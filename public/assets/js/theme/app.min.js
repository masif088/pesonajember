...
if (isSidebar.length > 0) {
    ...
    var AdminSettings = {
        ...
        ManageBoxedLayout: function () {
            ...
            console.log(settings.BoxedLayout)
            console.log(localStorage.getItem('BoxedLayout'))
            switch (settings.BoxedLayout) {
                ...
                case 'true':
                    ...
                    document.getElementById("full-layout").checked = false;
                    break;
                case false:
                case 'false':
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function handleBoxedLayout() {
            ...
            fullLayout.addEventListener("click", function () {
                localStorage.setItem('BoxedLayout', false)
                containerFluid.forEach(function (element) {
