...
class Transaction extends \App\Models\Transaction implements View
{
        ...
        return [
            ...
            ['type' => 'raw_html', 'data' => "
                <div class='flex gap-1'>
                    ...
                    <a href='$link2' class='btn bg-wishka-400  text-wishka-500 font-black text-nowrap flex justify-center'><i class='ti ti-cash text-xl'></i> <font style='margin: auto'> Tambah Pembayaran</font></a>
                </div>
