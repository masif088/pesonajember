...
//        dd($transactionTypeId);
    ...
    public static function tableData($data = null,$params=[]): array
    {
        ...
        if ($allHppValue==0){
            ...
            $hpp= '<div>Rp.'.thousand_format($allHppValue)."</div> <a href='$l' class='bg-green-100 hover:bg-green-200 text-green-900 text-nowrap rounded px-5 py-1 mt-1'>Edit</a>";
        }
        ...
        if ($allSharing==0){
            ...
            $sharing= '<div>Rp.'.thousand_format($allSharing)."</div><a href='$l' class='bg-green-100 hover:bg-green-200 text-green-900 text-nowrap rounded px-5 py-1 mt-1'>Edit</a>";
        }
